...
argument-hint: '[--wait|--background] [--base <ref>] [--scope auto|working-tree|branch] [--model <model|spark|sol|terra|luna|astra>] [--effort <none|minimal|low|medium|high|xhigh|max|ultra>] [focus ...]'
