...
argument-hint: "[--background|--wait] [--resume|--fresh] [--model <model|spark|sol|terra|luna|astra>] [--effort <none|minimal|low|medium|high|xhigh|max|ultra>] [what Codex should investigate, solve, or continue]"
